...
function NewsArticle({data,articleCount}){
    ...
    return(
        ...
        <div className={containsInappropriateContent(data.title,data.description)?"news-page-cannot-show":""}>
            ...
            <div className= {(articleCount%2==0)?"news-page-body ":"news-page-body news-page-dont-show"} >
                <div className="news-page-body-item news-page-text-div">
                    <div  className="news-page-item-body">
                        <div  className="news-page-item-header">
                            {data.title}
                        </div>
                        <div className="news-page-item-info">
                            {data.author ? "Author: " + data.author : ""}<br/>
                            {data.publishedAt ? "Published At: " + data.publishedAt : ""}<br/>
                            {data.source.name ? "Source: " + data.source.name : ""}
                        </div>
                        {data.description}
                ...
                <div className="news-page-body-item news-page-image-div">
                    <img src={data.urlToImage ? data.urlToImage : newsNoLoadImage}  alt="hello" className="news-page-image" /> 
                </div>
            </div>
            

            <div className="news-page-too-small">
                <div className={(articleCount%2==1)?"news-page-body ":"news-page-body news-page-dont-show"}>
                    <div className="news-page-body-item news-page-image-div">
                        <img src={data.urlToImage ? data.urlToImage : newsNoLoadImage}  alt="hello" className="news-page-image" /> 
                    </div>
                    <div className="news-page-body-item news-page-text-div">
